...
\noindent
N.d.r. \\
Tutti gli $\varepsilon$ nelle dimostrazioni sono da considerarsi $\in \R$.
...
\noindent
Supponiamo che esistano due limiti $L \in \R$ e $L' \in \R$ tali che $\lim\limits_{x \to x_0} f(x) = L$ e contemporaneamente $\lim\limits_{x \to x_0} f(x) = L'$. \\
...
\noindent
Supponiamo $\lim\limits_{x \to x_0} f(x) = L \neq 0 \land \lim\limits_{x \to x_0} g(x) = 0$ \\
