...
\noindent
$\left | f(x) - L \right | < \varepsilon \iff f(x) \in (L - \varepsilon, L + \varepsilon)$
...
$\lim_{x \to x_0} f(x) = L \implies \exists \delta_1 > 0 : \forall x \in I_\delta(x_0) \cap (A \setminus \braces{x_0}) \ldotp \left | f(x) - L \right | < \varepsilon$ \\

$\lim_{x \to x_0} f(x) = L' \implies \exists \delta_2 > 0 : \forall x \in I_\delta(x_0) \cap (A \setminus \braces{x_0}) \ldotp \left | f(x) - L' \right | < \varepsilon$ \\

\noindent
Ponendo $\delta = min(\delta_1, \delta_2)$ si ottiene: \\


$\forall x \in I_\delta(x_0) \cap (A \setminus \braces{x_0}) \ldotp \left | L - L' \right | = \left | L - f(x) + f(x) - L' \right | \leq \left | L - f(x) \right | + \left | f(x) - L' \right |$ \\
